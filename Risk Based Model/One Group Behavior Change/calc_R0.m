...
R_h = ( 1/(P.gamma_h + P.mu_h))*P.beta_h*(calc_b_T(P.sigma_h,P.sigma_v, P.pi, init))/(P.H0*P.theta);
%not including theta because all bites happen on pop 1
R_v = (1/(P.nu_v + P.mu_v))*(P.nu_v/P.mu_v) * P.beta_v *(calc_b_T(P.sigma_h,P.sigma_v, P.pi, init)/(init(5)+init(6)+init(7)));
