...
% pbase.theta2  = 0.757;
% pbase.theta1  = 0.266;
 pbase.init_cumulative_infected  = 50;
 pbase.K_v  = 10000;
 pbase.pi1  = .8;
 pbase.pi2  = .8;
...
pnames = ...
    {'init_cumulative_infected',
    'K_v',
    'pi1',
    'pi2'};

generate_plots(pbase, prange, pnames,'x', dirname, blackboxHandle);
